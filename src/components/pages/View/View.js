...
var View = React.createClass({
    mixins: [Navigation, AccountsMixin],
    ...
    onSubmit: function(e) {
        ...
        AccountActions.update(this.state.account);
                    ...
                    <form className="form-horizontal">
                        ...
                        { this.state.editing ?
                            <div className="col-md-offset-3 col-md-9">
                                <button type="button" onClick={this.onSubmit} className="btn btn-lg btn-primary"><span className="glyphicon glyphicon-floppy-save"></span> Submit</button>
                                <button type="button" onClick={this.stopEditing} className="btn btn-lg btn-primary"><span className="glyphicon glyphicon-ban-circle"></span> Cancel</button>
                            </div>
                            :
                            <div className="col-md-offset-3 col-md-9">
                                <button type="button" onClick={this.startEditing} className="btn btn-lg btn-primary"><span className="glyphicon glyphicon-edit"></span> Edit</button>
                            </div>
                        }
                        </div>
                    </form>
